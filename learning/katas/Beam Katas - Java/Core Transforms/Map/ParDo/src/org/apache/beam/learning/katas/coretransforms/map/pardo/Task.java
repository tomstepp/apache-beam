...
public class Task {
  ...
  static class MultiplyFn extends DoFn<Integer, Integer> {
    @ProcessElement
    public void processElement(@Element Integer num, OutputReceiver<Integer> out) {
      out.output(num * 10);
    }
  }

  static PCollection<Integer> applyTransform(PCollection<Integer> input) {
    return input.apply(ParDo.of(new MultiplyFn()));
  }
